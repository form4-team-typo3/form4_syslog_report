...
class LogService
{
    ...
    public function clearCachePagesLogs(iterable $logEntries, StandaloneView $view): void
    {
     ...
     * @return void
     */
    public function clearCacheAllLogs(iterable $logEntries, StandaloneView $view): void
    {
        $logEntriesAll = [];
        foreach ($logEntries as $key => $logEntry) {
            $logData = $logEntry->getLogData();
     ...
     * @return void
     */
    public function clearCachePageLogs(string $clearcachepage, iterable $logEntries, StandaloneView $view): void
    {
    ...
    protected function groupLogEntriesByPageAndDay(array $logEntries, bool $groupByPage = false): array
    {
        ...
        foreach ($logEntries as $entry) {
            ...
            $timestampDay = strtotime($tStamp->format('Y-m-d 00:00:00'));
